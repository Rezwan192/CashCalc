  ...
  return (
    <div className="SideLayout">
      <nav>
        ...
        <div className="items">
          <Link to="/CashCalc/" className="linkName">
            Dashboard{" "}
          </Link>
        ...
        <div className="items">
          <Link to="/CashCalc/User_input" className="linkName">
            Get Started{" "}
          </Link>
        ...
        <div className="items">
          <Link to="/CashCalc/BudgetPlanning" className="linkName">
            Budget Planning{" "}
          </Link>
        ...
        <div className="items">
          <Link to="/CashCalc/Profile" className="linkName">
            Profile{" "}
          </Link>
